...
console.log("categories",categories)
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get('http://localhost:6001/api/v1/AdminDash/getDiomandShepa');
  ...
  const handleDelete = async (productId) => {
    try {
      await axios.delete(`http://localhost:6001/api/v1/AdminDash/deletedDiomandCatogary/${productId}`);
