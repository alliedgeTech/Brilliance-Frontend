              ...
              <div className="row">
                <div className="col-xl-3 col-lg-3 col-md-12 col-12 sidebar left-sidebar md-b-50 p-t-10">
                  ...
                  <div className="block block-product-cats">
                    ...
                    {DiomandShape &&
                      DiomandShape.map((item, index) => {
                        return (
                          <>
                            <div className="block-content text-2xl pl-2">
                  ...
                  <div className="block block-product-filter">
                    <div className="bg-white rounded-lg shadow-md p-3 w-full max-w-md">
                      <div className="py-3">
                      ...
                      <div className="mb-2">
                        <label
                          htmlFor="min-price"
                          className="block text-gray-700 text-2xl mb-1"
                        >
                          Min Price
                        </label>
                        <input
                          type="range"
                          id="min-price"
                          className="w-full accent-[#cb8161] h-4"
                          min="0"
                          max="5000"
                          value={minPrice}
                  ...
                  <div className="block block-product-filter clearfix">
                    <div className="bg-white rounded-lg shadow-md p-3 w-full max-w-md">
                      <div className="py-3">
                        <h2 className="text-3xl font-bold">CLARITY</h2>
                      </div>
                      <div className="block-content">
                        <div className="flex flex-col lg:flex-row gap-3 p-2 mb-3">
                          {rangeLabels1.slice(0, 4).map((label, index) => (
                            <label key={index} className="flex items-center">
                              <input
                                ...
                                className="mr-1"
                              />
                              <span className="text-lg pb-[1px] px-1 text-gray-700">
                                {label}
                              </span>
                            </label>
                          ))}
                        ...
                        <div className="flex flex-col lg:flex-row gap-3 p-2 mb-2">
                  ...
                  {/* Cut Filter Block */}
                  <div className="block block-product-filter clearfix mb-4">
                    <div className="bg-white rounded-lg shadow-md p-3 w-full max-w-md">
                      <div className="py-3">
                        <h2 className="text-3xl font-bold">CUT</h2>
                      </div>
                      <div className="">
                          ...
                          {rangeLabels.map((label, index) => (
                            <label key={index} className="flex items-center">
                              <input
                                ...
                                className="mr-1 "
                              />
                              <span className="text-xl pb-[1px] px-1 text-gray-700">
                                {label}
                              </span>
                            </label>
                          ))}
                ...
                <div className="col-xl-9 col-lg-9 col-md-12 col-12">
                  ...
                  <div className="flex gap-4  p-4">
                    <div className="bg-white flex items-center text-center text-xl rounded-md shadow-md">
                      <button
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-4">
                              {Diomands.map((diamond, index) => (
                                <div key={index} className="col-span-1">
                                  <div className="products-entry clearfix product-wapper shadow-md h-full  rounded-lg">
                                    <Link
                                      to={`/single/${diamond._id}`}
                                      onClick={() =>
                                        addToRecentlyViewed(diamond)
                                      }
                                    >
